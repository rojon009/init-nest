...
export class ExampleController {
    ...
    getUsersManage() {
        return {
            message: 'This endpoint requires BOTH users.read AND users.update permissions',
        };
    }
    ...
    getAdminDelete() {
        return {
            message: 'This endpoint requires ANY of: users.delete, roles.delete, or permissions.delete',
        };
    }
